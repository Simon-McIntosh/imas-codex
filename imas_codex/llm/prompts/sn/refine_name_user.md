...
- **Locus prepositions:** Follow the installed locus relation matrix. Use
  `locus_relation="of"` for an intrinsic geometric property or object
  association, and `locus_relation="at"` for a field evaluated at a position.
  A registered locus may support both relations because the quantity semantics
