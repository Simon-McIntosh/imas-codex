...
| `sn themes` | Cluster + label thematic groups across the StandardName corpus | `--domain`, `--limit` |
| `sn analyse-comments` | Mine reviewer comments for recurring themes and prompt-feedback patterns | `--domain`, `--limit` |
