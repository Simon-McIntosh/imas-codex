...
Operational ids, statuses and source types remain internal. DD/signal paths
and optional value-estimator provenance are public.
...
def test_emits_source_type_and_provenance_when_present() -> None:
    ...
    assert src["provenance"] == "reconstructed"
